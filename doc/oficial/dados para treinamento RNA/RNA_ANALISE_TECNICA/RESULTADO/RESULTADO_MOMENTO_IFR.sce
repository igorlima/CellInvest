clear;
path_resultado = get_absolute_file_path('RESULTADO_MOMENTO_IFR.sce');
...
for i=1:length( dados_entrada(:,1) )
  saida_rna = rna_ifr( dados_entrada(i,1)/100 );
...
gravarDados( path_resultado + '\Saida\RESULTADO_MOMENTO_IFR_'+codigoAtivo+'.txt', resultado );
